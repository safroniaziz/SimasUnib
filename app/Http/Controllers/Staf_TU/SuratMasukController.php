...
namespace App\Http\Controllers\Staf_TU;
...
class SuratMasukController extends Controller
{
    ...
    public function store(Request $request){
        $this->validate($request,[
            ...
            'id_pejabat_disposisi'    =>  'required|string|',
            'id_jenis_surat'    =>  'required|string|',
    ...
    public function dataTable(){
        $model = DB::table('tb_surat_masuk')
                ...
                ->join('tb_pejabat_disposisi','tb_pejabat_disposisi.id','tb_surat_masuk.id_jenis_surat')
