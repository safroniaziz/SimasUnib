...
class SuratKeluarEksternalController extends Controller
{
    ...
    public function index(){
        return view('admin/surat_keluar.eksternal');
    }
    ...
    public function dataTable(){
        $model = DB::table('tb_surat_keluar')
                ...
                ->select('tb_surat_keluar.id','tipe_surat','pengirim_surat.nm_satuan_kerja_singkat as nm_pengirim_surat','tb_surat_keluar.penerima_surat as nm_penerima_surat',
