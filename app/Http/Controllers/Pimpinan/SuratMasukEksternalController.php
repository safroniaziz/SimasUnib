        ...
        return DataTables::of($model)
                ...
                ->addColumn('action', function($model){
                    if($model->status_teruskan == 0  && $model->status_baca == 0){
                        return
                        '<a href="' . route('pimpinan.surat_masuk_eksternal.baca_surat', $model->id) .'" class="btn social-btn btn-success" style="padding:5px;font-size:10px;"><i class="fa fa-envelope"></i></a>'.
                        '<a onclick="teruskanSuratMasukEksternalPimpinan('.$model->id.')"  class="btn social-btn btn-primary " style="padding:5px;font-size:10px; pointer-events: none;"><i class="fa fa-send-o"></i></a> ';
                    } else if($model->status_baca == 1 && $model->status_teruskan ==0){
                        return
                        '<a href="' . route('pimpinan.surat_masuk_eksternal.baca_surat', $model->id) .'"  class="btn social-btn btn-success " style="padding:5px;font-size:10px;"><i class="fa fa-envelope"></i></a> '.
                        '<a onclick="teruskanSuratMasukEksternalPimpinan('.$model->id.')"  class="btn social-btn btn-primary " style="padding:5px;font-size:10px;"><i class="fa fa-send-o"></i></a> ';
