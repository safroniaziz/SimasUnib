...
@section('manajemen-table')
  <div class="row">
    <div class="col-12 table-responsive">
      <table id="admin-table-surat-masuk-eksternal" class="table dt-responsive table-hover table-striped table-bordered nowrap " style="width:100%;">
        <thead>
          <tr class="tr-header">
          <td>No</td>
          <td>Tipe Surat</td>
...
@push('scripts')
     <script>
        $('#admin-table-surat-masuk-eksternal').DataTable({
          responsive: true,
            processing: true,
            serverside: true,
            ajax: "{{ route('admin.surat_masuk_eksternal.api') }}",
            columns: [
