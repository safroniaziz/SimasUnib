...
@endsection
@section('manajemen-title','Data Surat Keluar eksternal')
@section('manajemen-button-tambah')
    {{-- <div class="wrapper ml-auto action-bar">
        <a href="{{ route('admin.surat_keluar_eksternal.create') }}" class="btn btn-primary btn-flat modal-show" title="Tambah Pejabat Disposisi"><i class="fa fa-plus text-white"></i>Tambah Pejabat Disposisi</a>
    </div> --}}
@endsection
@section('manajemen-table')
<div class="row">
    <div class="col-12 table-responsive">
      <table id="admin-table-surat-keluar-eksternal" class="table dt-responsive table-hover table-striped table-bordered nowrap " style="width:100%;">
        <thead>
          <tr class="tr-header">
          <td>No</td>
          <td>Tipe Surat</td>
...
@push('scripts')
  <script>
        $('#admin-table-surat-keluar-eksternal').DataTable({
          responsive: true,
            processing: true,
            serverside: true,
            ajax: "{{ route('admin.surat_keluar_eksternal.api') }}",
            columns: [
