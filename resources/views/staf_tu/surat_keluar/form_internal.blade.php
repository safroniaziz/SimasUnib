            ...
            <div class="col-md-10 col-sm-9 col-12">
                <div class="row">
                    <div class="form-group col-md-6 col-sm-6 col-12" id="form-jenis-surat" >
                        ...
                        <select name="id_satuan_kerja_penerima" id="id_satker_penerima_surat" class="form-control">
                            <option value="0" selected="true">-- pilih penerima surat --</option>
                            <?php 
                                foreach ($id_penerima as $value) {
                                    ?>
                                        <option value="{{ $value->id }}">{{ $value->nm_satuan_kerja  }} ({{ $value->nm_satuan_kerja_singkat }})</option>
                                    <?php
                                }    
                            ?>
                        </select>
