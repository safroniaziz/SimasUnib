<div id="form-surat-masuk-staf-tu" style="display:none;">
    <form method="POST" class="form-horizontal" id="form-surat-masuk" data-toggle="validator" role="">
        ...
        <div class="row">
            ...
            <div id="form-internal" class=" col-md-3" >
                <label for="">Pilih Pengirim Surat :</label>
                <select name="id_satker_pengirim_surat" id="id_satker_pengirim_surat" class="form-control">
                    <option value="0" selected="true">-- pilih pengirim surat --</option>
                    <?php 
                        foreach ($id_pengirim as $value) {
                            ?>
